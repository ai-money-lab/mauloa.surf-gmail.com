...
PLATFORM_SPECS: dict[Platform, dict[str, Any]] = {
    ...
    Platform.SHUTTERSTOCK: {
        "portal": "Shutterstock Contributor",
        "requirements": [
            "画像: JPEG 4MP以上",
            "動画: MOV/MP4 HD以上",
            "AI生成タグ必須",
            "メタデータ: タイトル、説明、キーワード（英語）",
            "Shutterstock Contributorアカウント",
        ],
        "fee": "ロイヤリティ15-40%（累計売上で段階的に上昇）",
        "revenue_model": "DLあたり課金",
        "ai_policy": "AI生成OK（タグ必須、著作権侵害コンテンツ禁止）",
    },
    Platform.POND5: {
        "portal": "Pond5 Contributor",
        "requirements": [
            "動画: MOV/MP4 HD/4K（AI動画OK）",
            "音楽: WAV/AIF（AI音楽OK）",
            "AI画像は不可（公式FAQ確認済み）",
            "AI生成の明示",
            "メタデータ（英語）",
